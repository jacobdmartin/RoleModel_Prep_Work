...
describe '#Song' do
  ...
  describe('#==') do
    it("is the same song if it has the same attributes as another song") do
      song = Song.new({:name => "In Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 1})
      song2 = Song.new({:name => "In Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 2})
  ...
  describe('.all') do
    it("returns a list of all songs") do
      song = Song.new({:name => "In Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 1})
      song.save()
      song2 = Song.new({:name => "On Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 2})
      song2.save()
  ...
  describe('.find_by_album') do
    it("finds songs for an album") do
      album = Album.new({:name => "In Rainbows", :artist => "Radiohead", :year => 2007, :genre => "Rock", :length => "42:39", :id => 1})
      album.save
      song = Song.new({:name => "In Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 1, :album_id => nil})
      song.save()
      song2 = Song.new({:name => "In Rainbows", :artist => "Radiohead", :lyrics => "42:39", :id => 2, :album_id => nil})
      song2.save()
